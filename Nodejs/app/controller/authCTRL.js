...
const authCTRL = {
    register: async (req, res) => {
        try {
            ...
            //! jsonWebToken SEND
            const accessToken = createAccessToken({ id: user._id,role: user.role,email: user.email,fullname: user.fullname })
            const refreshToken = createRefreshToken({ id: user._id,role: user.role,email: user.email,fullname: user.fullname })
